class Settings:
    ...
    face_bbox_height_ratio = 0.6  # 얼굴 박스 높이 축소 비율입니다. (0.6이면 원래 크기의 60%로 줄입니다.)
    license_plate_bbox_width_ratio = 1.0  # 번호판 박스 너비 축소 비율.
    license_plate_bbox_height_ratio = 1.0  # 번호판 박스 높이 축소 비율.
    ...
    config_path = 'detection_api/model/custom.data'
